...
class ContrastiveAttention(nn.Module):
    def __init__(self,input_dim,output_dim, n_epochs,n_epochs_decay,batch_size=1,norm_layer=nn.InstanceNorm2d, n_filter=64, lambda_GAN=1.0, lambda_NCE=1.0, nce_idt=False, 
        ...
        self.optimizers = []
        visual_names = ['real_A', 'fake_B', 'real_B','o1_b', 'o2_b', 'o3_b', 'o4_b', 'o5_b', 'o6_b', 'o7_b', 'o8_b', 'o9_b', 'o10_b',
    ...
    def forward(self):
        ...
        self.i1_b, self.i2_b, self.i3_b, self.i4_b, self.i5_b, self.i6_b, self.i7_b, self.i8_b, self.i9_b = self.netG(self.real)
